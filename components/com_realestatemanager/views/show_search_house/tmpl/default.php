...
<script type="text/javascript"> 
       ...
       jQuerREL(function() {
            jQuerREL("#rem_slider").slider({
                min: 0,
                max: <?php echo $max_price; ?>,
                values: [0,<?php echo $max_price; ?>],
                range: true,
                stop: function(event, ui) {
                    jQuerREL("input#pricefrom").val(jQuerREL("#rem_slider").slider("values",0));
                    jQuerREL("input#priceto").val(jQuerREL("#rem_slider").slider("values",1));
                },
            ...
            jQuerREL("input#pricefrom").change(function(){
                ...
                jQuerREL("#rem_slider").slider("values",0,value1);
            });
            ...
            jQuerREL("input#priceto").change(function(){
                ...
                var value2=jQuerREL("input#priceto").val();
                    ...
                    jQuerREL("input#priceto").val(<?php echo $max_price; ?>)
              
                if(parseInt(value1) > parseInt(value2)){
                    value2 = value1;
                    jQuerREL("input#priceto").val(value2);
                }
                jQuerREL("#rem_slider").slider("values",1,value2);
            });
        });
    </script>
