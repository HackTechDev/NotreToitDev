            ...
            if ($tmp[5] == "OK" && mosRealEstateManagerImportExport::getXMLItemValue($house, 'images') != "") {
               ...
               //get orders
                  ...
                  for ($j = 0; $j < $orders_list->length; $j++) {
                      ...
                      $order_data = mosRealEstateManagerImportExport::getXMLItemValue($orders, 'data');
                      ...
                      $database->setQuery("INSERT INTO #__rem_orders " .
                              ...
                              "', '" . $order_payer_status . "');");
                      $database->query();
                      $database->setQuery("UPDATE #__rem_orders SET fk_vehicle_id =" . $house_class->id . " WHERE fk_vehicle_id = " . $old_house_id . "");
                      $database->query();
